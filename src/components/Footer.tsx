      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-20 grid grid-cols-1 md:grid-cols-12 gap-12 border-b border-white/10">
          ...
          <div className="md:col-span-5">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-white text-lg tracking-wider font-medium">
                POHANG <span className="text-sunrise-light">SUDAL</span>
              </span>
            </div>
          ...
          <div className="md:col-span-3">
            <h3 className="text-gold text-xs tracking-[0.2em] uppercase font-medium mb-6">
              Tours
            </h3>
          ...
          <div className="md:col-span-4">
            ...
            <div className="mt-8">
              <Link
                href="/booking"
                className="inline-block border border-white/20 text-white/60 px-6 py-2.5 text-xs tracking-widest uppercase hover:bg-white/10 transition-colors"
              >
                Book a Tour
              </Link>
            </div>
        ...
        <div className="py-8 flex flex-col sm:flex-row items-center justify-between text-xs">
          ...
          <p className="mt-2 sm:mt-0">Licensed Tour Interpreter Guide (관광통역안내사)</p>
        </div>
      </div>
    </footer>
  );
